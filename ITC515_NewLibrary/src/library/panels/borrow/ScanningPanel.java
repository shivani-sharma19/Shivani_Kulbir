...
public class ScanningPanel extends ABorrowPanel {
	...
	public ScanningPanel(IBorrowUIListener listener) {
		...
		panel_4.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Pending Loan List",
		...
		panel_3.setBorder(
				new TitledBorder(null, "Borrower Details", TitledBorder.LEADING, TitledBorder.TOP, null, null));
		...
		panel_7.setBorder(
				new TitledBorder(null, "Borrowing Restrictions", TitledBorder.LEADING, TitledBorder.TOP, null, null));
